...
namespace CodingStandard\Sniffs\Variables;

use PHP_CodeSniffer\Files\File;
use PHP_CodeSniffer\Sniffs\Sniff;
use PHP_CodeSniffer\Util\Tokens;
use CodingStandard\Helpers\ParameterHelper;
use CodingStandard\Helpers\PropertyHelper;
use CodingStandard\Helpers\ScopeHelper;
use CodingStandard\Helpers\TokenHelper;
use CodingStandard\Helpers\VariableHelper;
...
class UnusedVariableSniff implements Sniff
{
    ...
    /**
     * @phpcsSuppress CodingStandard.TypeHints.ParameterTypeHint.MissingNativeTypeHint
